...
3. **KySignOn OIDC SSO Authentication**: Protects the dashboard and administrative operations via OpenID Connect (OIDC) Authorization Code Flow with PKCE (`S256`), SQLite session management, and RBAC (`admin`, `operator`, `viewer`).
