...
func TestKyPasswordAdapterCaptureAndVerify(t *testing.T) {
	ctx := context.Background()
	adp := adapter.NewKyPasswordAdapter()
	...
	packResult, err := capsule.Pack(capsule.PackOptions{
		CapsuleID:    "cap-kypassword-drill-001",
	...
	scratchDir, err := os.MkdirTemp("", "kyrecovery-pwd-drill-*")
	if err != nil {
